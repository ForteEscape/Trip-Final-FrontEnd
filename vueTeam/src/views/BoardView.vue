...
<template>
  <div class="boardWrapper">
    ...
    <div class="button-container">
      <button type="button" class="btn button-basic" @click="toBoardWrite">글 작성하기</button>
    </div>
    <hr style="width: 90%;">
      <div class="contentWrapper shadow-inset scrollbar">

        <div v-for="b in boards" :key="b.id" class="card mb-3 content shadow" @click="toBoardDetail(b.id)">
          <div class="row g-0">
            <div class="col-md-3">
